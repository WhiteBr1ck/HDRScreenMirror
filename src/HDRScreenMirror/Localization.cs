...
internal static class Localization
{
    ...
    private static readonly IReadOnlyDictionary<string, string> ChineseStrings =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["OverlayMetrics"] = "{0,4:F1} fps   鼠标 {1}   超时 {2}",
            ["CursorOn"] = "开",
            ["CursorOff"] = "关",
            ...
            ["CursorRendered"] = "已渲染",
            ["CursorWaiting"] = "等待形状",
            ["RunningStatus"] = "运行中  {0:F1} fps  输入={1}  {2}  尺寸={3}×{4}  鼠标={5}  总帧={6}  等待超时={7}",
            ["Running"] = "运行中",
    ...
    private static readonly IReadOnlyDictionary<string, string> EnglishStrings =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["OverlayMetrics"] = "{0,4:F1} fps   CURSOR {1}   TIMEOUT {2}",
            ["CursorOn"] = "ON ",
            ["CursorOff"] = "OFF",
            ...
            ["RunningStatus"] = "Running  {0:F1} fps  input={1}  {2}  size={3}×{4}  cursor={5}  frames={6}  timeouts={7}",
            ["Running"] = "Running",
