...
internal static class Localization
{
    ...
    private static readonly IReadOnlyDictionary<string, string> ChineseStrings =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["AblProfilesSubtitle"] = "保存不同 OLED 的窗口亮度数据，并在镜像运行期间快速切换。",
            ["AblProfiles"] = "配置档案",
            ["AblMeasurements"] = "窗口峰值亮度",
            ["AblProfileName"] = "配置名称",
            ["AblMeasurementsHelp"] = "1% 与 100% 必填；其他节点可留空，程序会按 APL 对数坐标自动插值。",
            ["AblEotfTitle"] = "峰值亮度 EOTF",
            ["AblEotfHelp"] = "拖动圆点调整曲线，拖动菱形裁切点设置峰值位置；虚线为标准 PQ。",
    ...
    private static readonly IReadOnlyDictionary<string, string> EnglishStrings =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["AblProfilesSubtitle"] = "Save window luminance measurements for different OLED displays and switch profiles while mirroring.",
            ["AblProfiles"] = "Profiles",
            ["AblMeasurements"] = "Window peak luminance",
            ["AblProfileName"] = "Profile name",
            ["AblMeasurementsHelp"] = "1% and 100% are required. Leave other points blank to interpolate them on a logarithmic APL scale.",
            ["AblEotfTitle"] = "Peak luminance EOTF",
            ["AblEotfHelp"] = "Drag circles to edit the curve and the diamond clipping point to set where peak luminance begins. The dashed line is standard PQ.",
